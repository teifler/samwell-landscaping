  ...
  return (
    <div className="service-container">
      ...
      <div className="service-head">
        ...
        <p id="hard-div" className="head-txt">
          Custom hardscapes can allow you to expand your entertainment space outdoors. We specialize in custom hardscape
          design and installations. Whether you’re interested in a patio, fire pit, retaining/seating walls, or walkway
