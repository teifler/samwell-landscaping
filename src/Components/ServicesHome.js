  ...
  return (
    <div id="servicez" className="service-container">
      ...
      <div className="landscapes">
        ...
        <div className='className="lax lax_preset_fadeIn:50:100 lax_preset_spin"'>
          <h1 className="services-title">LANDSCAPES</h1>
          <p className="services-subtitle">PRECISION CRAFTED</p>
          <p className="services-div">
      ...
      <div className="hardscapes">
        ...
        <div>
          ...
          <p className="services-div">
            Custom hardscapes can allow you to expand your entertainment space outdoors. We specialize in custom
            hardscape design and installations.
          </p>
